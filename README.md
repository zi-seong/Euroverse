...
<br>
(2020/04/24) 셀레늄 구동을 완성하지 못해 항공권 검색과 숙소 검색 기능은 작동하지 않습니다.
<br>
(2020/05/02) **EC2**의 **인스턴스**를 프리티어로 하나만 실행해야 무료인건데 두 개의 인스턴스를 동시실행하니 과금이 발생해서 **MongoDB** 인스턴스를 중지 하여서 채팅 기능이 실행되지 않습니다.
